...
namespace VogCodeChallenge.API.Repositories
{
    public class DatabaseEmployeeRepository : IEmployeeRepository
    {
        ...
        private readonly List<Employee> DatabaseEmployeeTable = new List<Employee>
        {
            new Employee
            {
                Id = 1,
        ...
        {
            return DatabaseEmployeeTable;
        }

        public IEnumerable<Employee> FindByDepartmentId(int departmentId)
        {
            return DatabaseEmployeeTable.FindAll(employee => employee.DepartmentId == departmentId);
        }
    }
}
